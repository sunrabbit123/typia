...
message __Main {
    _alt_ObjectGeneric.ISomething_lt_boolean_gt__comma__space_ObjectGeneric.ISomething_lt_number_gt__comma__space_ObjectGeneric.ISomething_lt_string_gt__agt_ value = 1;
}
